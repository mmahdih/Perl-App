...
my $username    = 'john2018Bates@gmail.com';  # Replace with your Gmail address
my $password    = 'lmdt xtzs yvtc syjj';     # Replace with your app-specific password

# Create the MIME entity (email message)
my $email = MIME::Entity->build(
    Type    => "multipart/mixed",
    From    => $username,
    To      => 'haidarymahdi321@gmail.com',
...
# Send the email
$smtp->mail($username);
$smtp->to('haidarymahdi321@gmail.com');
$smtp->data();
